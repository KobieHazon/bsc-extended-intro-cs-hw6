...
- Preserve the LZ answer triples from the written part of the assignment.
...
The tests cover the embedded tester, generator ordering, rotation examples, rolling fingerprints, Huffman compression round trips, optimal-code checks, matrix arithmetic and image operations, repetition-code decoding, and command-line behavior.
